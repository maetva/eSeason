...
/**
 * This class stands for RequestCpgMultiPayment StructType
 * @subpackage Structs
 */
class RequestCpgMultiPayment extends AbstractStructBase
{
    /**
     * The idOrder
     * @var string|null
    ...
    /**
     * Constructor method for RequestCpgMultiPayment
     * @uses RequestCpgMultiPayment::setIdOrder()
     * @uses RequestCpgMultiPayment::setIdPaymentType()
     * @uses RequestCpgMultiPayment::setIdUser()
     * @uses RequestCpgMultiPayment::setLanguage()
     * @uses RequestCpgMultiPayment::setPassword()
     * @uses RequestCpgMultiPayment::setPayment()
     * @uses RequestCpgMultiPayment::setPaymentType()
     * @uses RequestCpgMultiPayment::setValue()
     * @uses RequestCpgMultiPayment::setFidelityCard()
     * @uses RequestCpgMultiPayment::setFidelityUse()
     * @uses RequestCpgMultiPayment::setSharegroop()
     ...
     * Set idOrder value
     * @param string $idOrder
     * @return \Maetva\ESeason\WebCampServices\StructType\RequestCpgMultiPayment
     */
