...
/**
 * This class stands for ResponseCpgConfirmOrCancelOrder StructType
 * @subpackage Structs
 */
class ResponseCpgConfirmOrCancelOrder extends AbstractStructBase
{
    /**
     * The idUser
     * @var string|null
    ...
    /**
     * Constructor method for ResponseCpgConfirmOrCancelOrder
     * @uses ResponseCpgConfirmOrCancelOrder::setIdUser()
     * @uses ResponseCpgConfirmOrCancelOrder::setIdOrder()
     * @uses ResponseCpgConfirmOrCancelOrder::setError()
     * @uses ResponseCpgConfirmOrCancelOrder::setMessError()
     * @param string $idUser
     ...
     * Set idUser value
     * @param string $idUser
     * @return \Maetva\ESeason\WebCampServices\StructType\ResponseCpgConfirmOrCancelOrder
     */
