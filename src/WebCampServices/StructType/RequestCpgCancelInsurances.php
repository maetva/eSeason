...
/**
 * This class stands for RequestCpgCancelInsurances StructType
 * @subpackage Structs
 */
class RequestCpgCancelInsurances extends AbstractStructBase
{
    /**
     * The idUser
     * @var string|null
    ...
    /**
     * Constructor method for RequestCpgCancelInsurances
     * @uses RequestCpgCancelInsurances::setIdUser()
     * @uses RequestCpgCancelInsurances::setPassword()
     * @uses RequestCpgCancelInsurances::setLanguage()
     * @uses RequestCpgCancelInsurances::setIdStay()
     * @param string $idUser
     ...
     * Set idUser value
     * @param string $idUser
     * @return \Maetva\ESeason\WebCampServices\StructType\RequestCpgCancelInsurances
     */
