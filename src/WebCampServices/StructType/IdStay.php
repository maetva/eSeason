...
class IdStay extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $beginDate = null, ?string $endDate = null, ?\Maetva\ESeason\WebCampServices\StructType\IdProduct $idProduct = null, ?int $id2 = null, ?\Maetva\ESeason\WebCampServices\StructType\IdTariffProduct $idTariff = null, ?string $hash = null, ?string $wichStock = null)
    {
        $this
     ...
     * Set beginDate value
     * @param string $beginDate
     * @return \Maetva\ESeason\WebCampServices\StructType\IdStay
     */
