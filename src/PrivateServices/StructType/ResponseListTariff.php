...
/**
 * This class stands for ResponseListTariff StructType
 * @subpackage Structs
 */
class ResponseListTariff extends AbstractStructBase
{
    /**
     * The idUser
     * @var string|null
    ...
    /**
     * Constructor method for ResponseListTariff
     * @uses ResponseListTariff::setIdUser()
     * @uses ResponseListTariff::setCategoTariff()
     * @uses ResponseListTariff::setError()
     * @uses ResponseListTariff::setMessError()
     * @param string $idUser
     ...
     * Set idUser value
     * @param string $idUser
     * @return \Maetva\ESeason\PrivateServices\StructType\ResponseListTariff
     */
    ...
    public static function validateCategoTariffForArrayConstraintsFromSetCategoTariff(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $responseListTariffCategoTariffItem) {
            // validation for constraint: itemType
            if (!$responseListTariffCategoTariffItem instanceof \Maetva\ESeason\PrivateServices\StructType\CategoTariff) {
                $invalidValues[] = is_object($responseListTariffCategoTariffItem) ? get_class($responseListTariffCategoTariffItem) : sprintf('%s(%s)', gettype($responseListTariffCategoTariffItem), var_export($responseListTariffCategoTariffItem, true));
            }
        }
