...
class Stay extends AbstractStructBase
{
    ...
    /**
     * The idStay
     * @var \Maetva\ESeason\PrivateServices\StructType\IdStay|null
     */
    protected ?\Maetva\ESeason\PrivateServices\StructType\IdStay $idStay = null;
    /**
     * The price
     * @var float|null
     */
     ...
     * @var string|null
     */
    protected ?string $step3Url = null;
    /**
     * The DescrTariffBlueToolTips
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var string|null
     */
    protected ?string $DescrTariffBlueToolTips = null;
    /**
     * The flexDate
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @uses Stay::setIdCategYelloh()
     * @uses Stay::setLibCateg()
     * @uses Stay::setLibTariff()
     * @uses Stay::setStock()
     * @uses Stay::setStep3Url()
     * @uses Stay::setDescrTariffBlueToolTips()
     ...
     * @param int $idSite
     * @param \Maetva\ESeason\PrivateServices\StructType\IdStay $idStay
     * @param float $price
     ...
     * @param int $stock
     * @param string $step3Url
     * @param string $descrTariffBlueToolTips
     * @param bool $flexDate
     * @param bool $flexCapacity
     * @param \Maetva\ESeason\PrivateServices\StructType\SpecificParam[] $specificParam
     */
    public function __construct(?bool $cancelEnable = null, ?float $cancelInsurancePrice = null, ?float $deposit = null, ?float $expenseReservationPrice = null, ?int $idSite = null, ?\Maetva\ESeason\PrivateServices\StructType\IdStay $idStay = null, ?float $price = null, ?string $priceType = null, ?bool $promotion = null, ?bool $animal = null, ?int $personmin = null, ?int $personmax = null, ?\Maetva\ESeason\PrivateServices\StructType\PromoInfo $promoInfo = null, ?bool $selectPlace = null, ?bool $highlighted = null, ?string $highlightLabel = null, ?int $fidNights = null, ?string $fidComments = null, ?int $fidStatus = null, ?int $pertinence = null, ?bool $personSale = null, ?int $limitFull = null, ?string $idCategYelloh = null, ?string $libCateg = null, ?string $libTariff = null, ?int $stock = null, ?string $step3Url = null, ?string $descrTariffBlueToolTips = null, ?bool $flexDate = null, ?bool $flexCapacity = null, ?array $specificParam = null)
    {
        $this
            ...
            ->setStock($stock)
            ->setStep3Url($step3Url)
            ->setDescrTariffBlueToolTips($descrTariffBlueToolTips)
    ...
    /**
     * Get idStay value
     * @return \Maetva\ESeason\PrivateServices\StructType\IdStay|null
     */
    public function getIdStay(): ?\Maetva\ESeason\PrivateServices\StructType\IdStay
    {
        return $this->idStay;
    }
    /**
     ...
     * @return \Maetva\ESeason\PrivateServices\StructType\Stay
     */
    public function setIdStay(?\Maetva\ESeason\PrivateServices\StructType\IdStay $idStay = null): self
    {
        $this->idStay = $idStay;
    ...
    /**
     * Set priceType value
     * @uses \Maetva\ESeason\PrivateServices\EnumType\PriceType::valueIsValid()
     * @uses \Maetva\ESeason\PrivateServices\EnumType\PriceType::getValidValues()
    ...
    public function setPriceType(?string $priceType = null): self
    {
        ...
        if (!\Maetva\ESeason\PrivateServices\EnumType\PriceType::valueIsValid($priceType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\ESeason\PrivateServices\EnumType\PriceType', is_array($priceType) ? implode(', ', $priceType) : var_export($priceType, true), implode(', ', \Maetva\ESeason\PrivateServices\EnumType\PriceType::getValidValues())), __LINE__);
        }
     ...
     * @return string|null
     */
    public function getStep3Url(): ?string
    {
     ...
     * @return \Maetva\ESeason\PrivateServices\StructType\Stay
     */
    public function setStep3Url(?string $step3Url = null): self
    {
        // validation for constraint: string
        if (!is_null($step3Url) && !is_string($step3Url)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($step3Url, true), gettype($step3Url)), __LINE__);
        }
        $this->step3Url = $step3Url;
        
        return $this;
    }
    /**
     * Get DescrTariffBlueToolTips value
     * @return string|null
     */
    public function getDescrTariffBlueToolTips(): ?string
    {
        return $this->DescrTariffBlueToolTips;
    }
    /**
     * Set DescrTariffBlueToolTips value
     * @param string $descrTariffBlueToolTips
     * @return \Maetva\ESeason\PrivateServices\StructType\Stay
     */
    public function setDescrTariffBlueToolTips(?string $descrTariffBlueToolTips = null): self
    {
        // validation for constraint: string
        if (!is_null($descrTariffBlueToolTips) && !is_string($descrTariffBlueToolTips)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($descrTariffBlueToolTips, true), gettype($descrTariffBlueToolTips)), __LINE__);
        }
        $this->DescrTariffBlueToolTips = $descrTariffBlueToolTips;
    ...
    public static function validateSpecificParamForArrayConstraintsFromSetSpecificParam(?array $values = []): string
    {
        ...
        foreach ($values as $staySpecificParamItem) {
            ...
            if (!$staySpecificParamItem instanceof \Maetva\ESeason\PrivateServices\StructType\SpecificParam) {
