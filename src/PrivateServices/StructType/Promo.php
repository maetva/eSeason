...
class Promo extends AbstractStructBase
{
    ...
    /**
     * Set type value
     * @uses \Maetva\ESeason\PrivateServices\EnumType\PromoType::valueIsValid()
     * @uses \Maetva\ESeason\PrivateServices\EnumType\PromoType::getValidValues()
    ...
    public function setType(?string $type = null): self
    {
        ...
        if (!\Maetva\ESeason\PrivateServices\EnumType\PromoType::valueIsValid($type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\ESeason\PrivateServices\EnumType\PromoType', is_array($type) ? implode(', ', $type) : var_export($type, true), implode(', ', \Maetva\ESeason\PrivateServices\EnumType\PromoType::getValidValues())), __LINE__);
        }
        $this->type = $type;
